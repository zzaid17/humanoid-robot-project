...
: ${AMENT_CURRENT_PREFIX:="/home/asis/hokuyo_ws/src/install/imu_publisher_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_publisher_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_publisher_cpp/environment/path.sh"
